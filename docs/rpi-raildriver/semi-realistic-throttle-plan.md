...
- `java/src/jmri/util/usb/Bundle.properties` — add Bundle keys for the Settings-tab labels (scenario names, physics field labels, brake constant labels, button labels, status messages).
